 ...
 * Code copied from https://github.com/ryanleecode/postgres-error-codes (MIT licensed package).
 * All error codes are from the Postgres docs: https://www.postgresql.org/docs/9.2/errcodes-appendix.html
 */
